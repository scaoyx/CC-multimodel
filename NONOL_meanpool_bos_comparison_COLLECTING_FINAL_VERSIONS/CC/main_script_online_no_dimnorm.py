...
def main():
    ...
    if args.offline_mode:
        run_name = f"{n_sources}Modal_SAE_no_dimnorm_{mode_str}_{random.randint(1000, 9999)}{resume_suffix}"
    else:
        run_name = f"{n_sources}Modal_SAE_no_dimnorm_{mode_str}_{args.esm_model}_{random.randint(1000, 9999)}{resume_suffix}"
    ...
    # Import model class
    from sparse_auto_script_no_dimnorm import LitLit
    ...
    checkpoint_dir = Path("CC_concatenated_checkpoints_no_dimnorm") / run_name
